            ...
            <div class="col-12  align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    <div class="w-sm-100 mr-auto">
                        <h3 style="padding-left:15px;" class="mb-0"><b>All Products</b></h3>
                    </div>
                            ...
                            <table class="table layout-primary bordered">
                                ...
                                ?>
                                    <tbody>
                                        ...
                                        <td><img src="../user/<?php echo $data['image'];  ?>"  width="65px" height="65px" ></td>
                                ...
                                <!--        <td>
                                        ...
                                        <td>
                                            <a href="delete-product.php?product_id=<?php echo $data['product_id']; ?>">
