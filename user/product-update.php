                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    ?>
                                    <form action="product-update-save.php" method="post" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="category" class="form-control rounded" id="inputEmail4" value="<?php echo $product['category']; ?>">
